...
//    public $userCollect;
    ...
    public function rules()
    {
        return [
            ...
            [['status', 'recommend', 'created_at', 'updated_at', 'price', 'cid', 'subscribe'], 'integer'],
    ...
    public function beforeDelete()
    {
        ...
        if (CoursePassword::findOne(['course_id' => $this->id]) != null) {
            $this->addError('id', "付费课程,请先删除课时密码");
            return false;
        }
    ...
    {
        return $this->hasMany(UserCollect::className(), ['course_id' => 'id'])->cache(60)->count() * 3;
    }
}
