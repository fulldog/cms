...
/* @var $model common\models\CourseChildSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="course-child-search ibox-heading row search" style="margin-top: 5px;padding-top:5px">
    ...
    <?= $form->field($model, 'course_id', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
    ...
    <?php // echo $form->field($model, 'thumb', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
