...
<div class="vote-child-search ibox-heading row search" style="margin-top: 5px;padding-top:5px">
    ...
    <?= $form->field($model, 'vid', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
    ...
    <?= $form->field($model, 'pv', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
